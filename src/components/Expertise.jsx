...
const expertiseData = [
  {
    ...
    text: "Creating responsive and user-friendly interfaces with HTML, CSS, JavaScript, React and UI/UX principles.",
    tag: "UI / UX & WEB",
  ...
  },
  {
    ...
    text: "Building Android application concepts with Java and Android Studio, including structured data and user-focused screens.",
    tag: "MOBILE & APP",
  ...
  },
  {
    number: "03",
    title: "AI & Analytics",
    text: "Exploring AI analytics, predictive analytics, exploratory data analysis and local AI workflows through practical projects.",
    tag: "AI / DATA",
  ...
  },
  {
    ...
    text: "Applying Excel, data interpretation, data quality management, business communication, teamwork, leadership and decision making.",
    tag: "DATA / PROFESSIONAL",
      ...
      <div className="relative z-10 max-w-6xl mx-auto w-full space-y-12">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 pb-2">
          ...
          <p className="text-white/60 text-xs md:text-sm font-light leading-relaxed max-w-xs">
            Combining technology, analysis and design while learning by building practical digital products.
          </p>
        </div>
