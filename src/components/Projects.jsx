...
const projectsData = [
  { title: 'JARVIS AI Assistant', category: 'AI & Desktop Automation', description: 'A voice-controlled desktop assistant concept built with Python to understand spoken commands, open applications and websites, and connect with local AI workflows.', tags: ['Python', 'Voice AI', 'Ollama', 'Automation'], match: '95%', episode: 'S01 E01' },
  { title: 'ChatBox', category: 'Android Application', description: 'A Java Android messaging application concept with Firebase authentication, chat, media, groups and calling-focused UI planning.', tags: ['Java', 'Android Studio', 'Firebase', 'UI/UX'], match: '94%', episode: 'S01 E02' },
  { title: 'Vehicle & Fuel Tracker', category: 'Mobile App / Data', description: 'An Android application concept for recording fuel entries, tracking vehicle expenses, monitoring consumption and understanding spending patterns.', tags: ['Android', 'Java', 'Data Management', 'UI/UX'], match: '93%', episode: 'S01 E03' },
  { title: 'Personal Portfolio', category: 'Web Design / UI/UX', description: 'A cinematic Netflix-inspired portfolio designed to showcase skills, projects, experience, certifications and contact information.', tags: ['React', 'Vite', 'Tailwind CSS', 'GSAP'], match: '99%', episode: 'S01 E04' },
];
