...
const skillCategories = [
  { title: 'AI & Analytics', desc: 'Exploring AI workflows, predictive analytics, exploratory data analysis and practical automation while learning through projects.', tag: 'INTELLIGENCE', skills: ['AI Analytics', 'AI Strategy', 'Predictive Analytics', 'EDA'] },
  { title: 'App Development', desc: 'Building Android application concepts with Java, Android Studio and Firebase, with a focus on useful interfaces and structured data.', tag: 'MOBILE', skills: ['Java', 'Android Studio', 'Firebase', 'UI/UX'] },
  { title: 'Web Development', desc: 'Creating responsive portfolio and web experiences using modern frontend technologies with a strong focus on interaction and presentation.', tag: 'WEB / UI', skills: ['HTML', 'CSS', 'JavaScript', 'React'] },
  { title: 'Data & Tools', desc: 'Working with Excel, data interpretation, data quality, reporting, GitHub and VS Code for practical problem solving.', tag: 'DATA / TOOLS', skills: ['Excel', 'Data Entry', 'GitHub', 'VS Code'] },
  { title: 'Problem Solving', desc: 'Applying analytical thinking, decision making, teamwork, communication and strategic thinking to technology and business-oriented tasks.', tag: 'PROFESSIONAL', skills: ['Problem Solving', 'Decision Making', 'Teamwork', 'Leadership'] },
];
